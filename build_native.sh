...
# pushd $PWD
# cd ${CXX_GENERATOR_ROOT}
# DYLD_LIBRARY_PATH=${CLANG_ROOT_LOCAL}/lib /opt/local/bin/python2.7 ${CXX_GENERATOR_ROOT}/generator.py ${APP_ANDROID_ROOT}/cocosdenshion.ini -s cocosdenshion -o ${APP_ANDROID_ROOT}/jni/cocosdenshion_bindings
# popd
# pwd
# set +x
